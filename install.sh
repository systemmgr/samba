...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202207031529-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2023 Jason Hempstead, Casjays Developments
# @@Created          :  Tuesday, Jun 13, 2023 12:41 EDT
# @@File             :  install.sh
# @@Description      :  Install configurations for samba
...
__run_post_install() {
  ...
  if systemctl enable samba; then
    systemctl restart samba
  elif systemctl enable smbd nmbd; then
    systemctl restart smbd nmbd
  elif systemctl enable smb nmb; then
